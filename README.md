...
The size of these veins varies greatly. Sometimes you will find a vein with around 30 diamonds inside, and other times with 300 or more. Fully mining them out can be non-trivial, so larger veins act as long-term mining hubs rather than quick resource grabs. This variance is intentional. You can get lucky and completely break the emerald economy or jump straight to an effectively endless diamond source. Or you might find very little at all. Veins are generated by noise maps rather than being evenly distributed per chunk, so outcomes are unpredictable.
...
- [Universal Ores](https://modrinth.com/mod/universal_ores): adds the calcite ore blocks used by these veins
- [Custom Ore Veins](https://modrinth.com/mod/customoreveins): the framework the datapack uses to define these veins
